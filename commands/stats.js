  ...
  cpuStat.usagePercent(function(err, percent, seconds) {
    ...
    if (!args[0]) {
      let embedStats = new Discord.RichEmbed()
        ...
        .setTitle("***BOT Stats***")
        .setColor("RANDOM")
        .setDescription(`[Support Server](https://discord.gg/5YtKzWv) | [Invite](https://discordapp.com/oauth2/authorize?client_id=490609897176563735&scope=bot&permissions=2146958847)`)
